...
\end{eqnarray}
% De ce point vue, il est donc strictement équivalent de considérer trois particules libres, qui n'interagissent pas, dans un espace à une dimension ou une particule libre dans un espace à trois dimensions.
